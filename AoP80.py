...
with fits.open("AoP80/Q1-latest-whigal-85.fits", use_fsspec=True, fsspec_kwargs={"anon": True}) as hdul:  
...
#%%
plot_general(cutouts[1], dpi=300, colorbar=True, cmap="hot", title="Test plot 1", scale=20)
